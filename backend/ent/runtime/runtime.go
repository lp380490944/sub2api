...
func init() {
	...
	groupDescDefaultAccountConcurrency := groupFields[45].Descriptor()
	...
	groupDescDefaultAccountRpm := groupFields[46].Descriptor()
	...
	groupDescDefaultPassthroughProfile := groupFields[47].Descriptor()
	...
	groupDescDefault429CooldownSec := groupFields[48].Descriptor()
