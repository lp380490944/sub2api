...
func init() {
	...
	groupDescDefaultAccountConcurrency := groupFields[53].Descriptor()
	...
	groupDescDefaultAccountRpm := groupFields[54].Descriptor()
	...
	groupDescDefaultPassthroughProfile := groupFields[55].Descriptor()
	...
	groupDescDefault429CooldownSec := groupFields[56].Descriptor()
