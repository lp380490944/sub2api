...
func init() {
	...
	groupDescDefaultAccountConcurrency := groupFields[33].Descriptor()
	...
	groupDescDefaultAccountRpm := groupFields[34].Descriptor()
	...
	groupDescDefaultPassthroughProfile := groupFields[35].Descriptor()
	...
	groupDescDefault429CooldownSec := groupFields[36].Descriptor()
