...
func init() {
	...
	groupDescDefaultAccountConcurrency := groupFields[47].Descriptor()
	...
	groupDescDefaultAccountRpm := groupFields[48].Descriptor()
	...
	groupDescDefaultPassthroughProfile := groupFields[49].Descriptor()
	...
	groupDescDefault429CooldownSec := groupFields[50].Descriptor()
