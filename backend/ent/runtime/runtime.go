...
func init() {
	...
	groupDescDefaultAccountConcurrency := groupFields[46].Descriptor()
	...
	groupDescDefaultAccountRpm := groupFields[47].Descriptor()
	...
	groupDescDefaultPassthroughProfile := groupFields[48].Descriptor()
	...
	groupDescDefault429CooldownSec := groupFields[49].Descriptor()
