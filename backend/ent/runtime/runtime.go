...
func init() {
	...
	groupDescDefaultAccountConcurrency := groupFields[48].Descriptor()
	...
	groupDescDefaultAccountRpm := groupFields[49].Descriptor()
	...
	groupDescDefaultPassthroughProfile := groupFields[50].Descriptor()
	...
	groupDescDefault429CooldownSec := groupFields[51].Descriptor()
	...
	usagelogDescCachePolicyTrace := usagelogFields[44].Descriptor()
