...
func init() {
	...
	groupDescDefaultAccountConcurrency := groupFields[37].Descriptor()
	...
	groupDescDefaultAccountRpm := groupFields[38].Descriptor()
	...
	groupDescDefaultPassthroughProfile := groupFields[39].Descriptor()
	...
	groupDescDefault429CooldownSec := groupFields[40].Descriptor()
