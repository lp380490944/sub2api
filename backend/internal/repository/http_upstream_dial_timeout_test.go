...
func TestBuildUpstreamTransportSetsDialTimeout(t *testing.T) {
	...
	transport, err := buildUpstreamTransport(settings, nil, upstreamProtocolModeDefault, nil)
...
func TestBuildUpstreamTransportKeepsDialTimeoutWithHTTPProxy(t *testing.T) {
	...
	transport, err := buildUpstreamTransport(defaultPoolSettings(nil), proxyURL, upstreamProtocolModeDefault, nil)
	require.NoError(t, err)
